...
- **Αναζήτηση** — λήψη παραστατικών για διάστημα και αποθήκευση στο βιβλίο.
- **Βιβλίο εξόδων / Βιβλίο εσόδων** — τα παραστατικά ανά κατάσταση, με χαρακτηρισμό,
  μαζική αποστολή και ανανέωση κατάστασης από το myDATA.
